...
# irf: unit Instrumental Response Function (sum=1)
    ...
    M = intensity.shape[1-1]
    N = intensity.shape[2-1]
...
#             (maximum photon count)
                ...
                cur = decay # Pour l'insant je bypass le brut
